...
Nova.booting(function (Vue, router, store) {
    router.addRoutes([{
        name: 'nova-sidebar-icons',
        path: '/nova-sidebar-icons',
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Nova Sidebar Icons")]),
      _vm._v(" "),
      _c(
        "card",
        {
        ...
        [
          ...
          _c("p", { staticClass: "text-white-50% text-lg" }, [
            ...
            _c(
              ...
              [
                _vm._v(
                  "/nova-components/NovaSidebarIcons/resources/js/components/Tool.vue"
                )
              ]
            )
          ])
